  ...
  const faqs = [
    {
      ...
      answer:
        "This varies based on the size and complexity of the project, and is mostly dependent on number of pages and integrations. We launch incrementally, and should be able to ship you companies new website in 30-60 days.",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      answer:
        "We use cutting edge, enterprise grade technologies to make your business shine. This includes Next.js, React, tRPC, TypeScript, NextAuth, Tailwind CSS and more. We also excel in many other technology stacks, and are happy to dive into your businesses current tech if needed.",
    },
    {
      id: 6,
